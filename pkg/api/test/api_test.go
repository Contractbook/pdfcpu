...
// containing empty RD and LE arrays validate successfully in relaxed mode.
// This is common with "Microsoft: Print To PDF" which emits placeholder empty
// arrays. (The empty CL case is already handled by upstream.)
